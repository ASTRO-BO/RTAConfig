...
#ifndef _RTACONFIGLOAD_H
#define _RTACONFIGLOAD_H
...
namespace RTAConfig {
    ...
    public:
        ...
        RTAConfigLoad(const string& confInputFileName);
        ...
        struct RTAConfig::RTAConfigLoad::Array *getArrayStruct();
        
        /// It gets the telescope structure from the identification number
        struct RTAConfig::RTAConfigLoad::Telescope *getTelescopeStruct(int TelID);
        
        /// It gets the telescope type structure from the type identification number
        struct RTAConfig::RTAConfigLoad::TelescopeType *getTelescopeTypeStruct(int TelType);
        
        /// It gets the mirror structure from the mirror type identification number
        struct RTAConfig::RTAConfigLoad::MirrorType *getMirrorTypeStruct(int mirType);
        
        /// It gets the camera structure from the camera type identification number
        struct RTAConfig::RTAConfigLoad::CameraType *getCameraTypeStruct(int camType);
